          ...
          <Col md={6}>
            <div className="d-flex flex-column gap-3">
              ...
              <div className="d-flex gap-3 mt-2 justify-content-center justify-content-md-start">
                ...
                <a  href="https://www.linkedin.com/in/narasimman-s-profile/" target="_blank" rel="noopener noreferrer" className="btn btn-outline-primary rounded-circle p-2" style={{width:'40px',height:'40px'}}><i className="fab fa-linkedin-in"></i></a>
